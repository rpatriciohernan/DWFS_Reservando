...
Listado.prototype.buscarRestaurante  = function(id) {
    ...
    var restaurantEncontrado = this.restaurantes.find(restaurant => restaurant.id === id);
...
function eliminarRepetidos(listadoConRepetidos){

    var listadoSinRepetidos = listadoConRepetidos.filter(function(elem, index, self) {
        return index === self.indexOf(elem);
    });

    return listadoSinRepetidos;
}

//Obtiene todas las ciudades de los restaurantes sin repetidos
Listado.prototype.obtenerUbicaciones = function() {
    var ubicacionesConRepetidos = this.restaurantes.map(restaurant => restaurant.ubicacion);

    var ubicaciones = eliminarRepetidos(ubicacionesConRepetidos);
...
Listado.prototype.obtenerRubros = function() {
    var rubrosConRepetidos = this.restaurantes.map(restaurant => restaurant.rubro);
    
    var rubros = eliminarRepetidos(rubrosConRepetidos);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var listasDeHorarios = this.restaurantes.map(restaurant => restaurant.horarios);
    ...
    var horarios = eliminarRepetidos(horariosConRepetidos);
